...
const projectDetails = {
    ...
    FlashCardApp: {
        ...
        detail: "If you are her people then you will get to know the meaning of \"caring\". She thinks about you and your well being, your needs and what not.",
    ...
    Brainly: {
        ...
        detail: "Her person knows that he/she is \"her\" person only be it Chireya, Shruti, didi or Amanaa, they know the possesive ayushi",
    ...
    NewsPopularityPrediction1: {
        ...
        detail: "She can show you diffferent versions of her in small period of time and you cant predict what will be the next version.",
        githubLink: "https://github.com/ankit986/News-Popularity-Prediction",
        ...
        return (
            <div className='project-container' id="project">
                <div style={{ minHeight: '100vh' }}>
                    <Grid>
                        <Cell col={12}>
                            <h1 className='tc f1 line Shadow '>Features Of Ayushi</h1>
