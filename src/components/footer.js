...
class Footer extends React.Component {
    render() {
        return (
            <footer id="footer" style={{ background: "url(" + bgGif + ") center / cover" }} className="tc-l bg-center cover bg-black">
                <div className="w-100 ph3 pv4 bg-black-80">
                    ...
                    <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://medium.com/@ankitbansal1412/" title="Medium">
                    ...
                    <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://www.linkedin.com/in/ankitbansal1412/" title=" Linkedin">
                    ...
                    <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://twitter.com/ankitbansal1412" title=" Twitter">
