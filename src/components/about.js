                                ...
                                <Grid className=' shadow-3'>
                                    ...
                                    <Cell col={6}>
                                        ...
                                        <p className='about-me'>
                                            ...
                                            I have Learnt web development on my own.
                                          </p>
                                        <p className='about-me'>
                                            In the very first year of my graduation, I was selected for the <a className='color' alt='a' href='https://google.com'>Tuition Fee waiver scholarship</a> and got a 100% scholarship in my college tuition fees.
                                            I have been the <a className='color' alt='a' href='https://google.com'>vice president</a> of the CSE department in session 2018-19 and lead the team to organize various events.
                                          </p>
                                        <p className='about-me'>
